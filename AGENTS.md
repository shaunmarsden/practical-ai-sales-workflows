...
- [Sibling Repositories](guides/sibling-repositories.md), a scoping guide for adapting this repository's format to another business function, gated on a genuine practitioner from that function driving it, not a plan for this repository
- [Future Interfaces](guides/future-interfaces.md), design specs for four distant ideas (a role-play simulator, an interactive evidence workspace, an explainable lead-qualification view, a before-and-after instruction testing interface), none of which exist as software yet
...
- [Curated Bundles](guides/curated-bundles.md), three starting groupings of existing recipe cards (a starter pack, a post-call pack, a deal progression pack) for a first-time reader who does not want to read all seventeen cards to find their own job
