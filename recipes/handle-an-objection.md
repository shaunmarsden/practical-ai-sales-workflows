...
Also: [Prompt](../templates/objection-handling-prompt.md) · [Skill](../.agents/skills/objection-response/SKILL.md) · [Worked example](../examples/hartwell-objection-response.md)
