...
```mermaid
flowchart TB
    A["1. Record what actually changed<br/>audience, source, message, one variable or several"]
    B["2. Read the raw numbers straight<br/>no rounding up, no stopping at the flattering figure"]
    C["3. Mark small or mixed samples inconclusive<br/>you decide what to test next"]
    A --> B --> C
```
