...
```mermaid
flowchart TB
    A["1. Confirm it is indecision<br/>not an objection or a real blocker"]
    B["2. Reduce the risk of deciding<br/>recommend, shrink, reassure"]
    C["3. Offer a safe next step<br/>do not push, do not invent terms"]
    A --> B --> C
```
...
- [See a harder test: reasons that resolve, then repeat as something new](../examples/wrenmoor-indecision-response.md), [and its review](../evaluations/wrenmoor-indecision-review.md)
