...
```mermaid
flowchart TB
    A["1. Add the call evidence<br/>Transcript, notes and useful context"]
    B["2. Let AI prepare the work<br/>Summary, actions, email and CRM suggestions"]
    C["3. Check and use it<br/>Confirm facts, commitments and tone"]
    A --> B --> C
```
