...
```mermaid
flowchart TB
    A["1. Map stakeholders to evidence<br/>not to job titles"]
    B["2. Build what the champion needs<br/>summary, role-specific points, honest answers"]
    C["3. Champion carries it themselves<br/>the seller never contacts anyone else directly"]
    A --> B --> C
```
