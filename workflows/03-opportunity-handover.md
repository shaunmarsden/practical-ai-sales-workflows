...
```mermaid
flowchart TB
    A["1. Gather the useful evidence<br/>Calls, CRM notes, emails and actions"]
    B["2. Build the handover<br/>Position, people, risks and next action"]
    C["3. Check it together<br/>Correct gaps and confirm ownership"]
    A --> B --> C
```
