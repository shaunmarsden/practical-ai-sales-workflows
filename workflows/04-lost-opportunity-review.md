...
```mermaid
flowchart TB
    A["1. Separate what was said<br/>from what you're assuming"]
    B["2. Work out what kind of loss this is<br/>Fit, timing, stakeholder, or blocker"]
    C["3. Decide if there's a real route back<br/>Or file it and move on"]
    A --> B --> C
```
