...
This page separates what is available from what has actually been tested.
...
| Sales Job | Workflow | Skill | Fictional Test | Real Use | External User Test |
| --- | --- | --- | --- | --- | --- |
| [Find the Next Prospect](recipes/find-the-next-prospect.md) | [Yes](workflows/09-outbound-prospecting.md) | [Yes](.agents/skills/outbound-prospecting/SKILL.md) | [Scored](evaluations/cedarwell-outbound-review.md) | [Test logged](CHANGELOG.md#real-use-findings) | Not yet |
| [Prepare for a Sales Call](recipes/prepare-for-a-sales-call.md) | [Yes](workflows/01-pre-call-preparation.md) | [Yes](.agents/skills/prepare-for-sales-call/SKILL.md) | [Scored](evaluations/hartwell-pre-call-review.md) | [Used live, not formally logged](CHANGELOG.md#used-live-without-a-formal-test) | Not yet |
| [Follow Up After a Sales Call](recipes/follow-up-after-a-sales-call.md) | [Yes](workflows/02-post-call-follow-up.md) | [Two skills](.agents/skills/extract-post-call-evidence/SKILL.md) | [Scored](evaluations/hartwell-post-call-review.md) | [Test logged](CHANGELOG.md#real-use-findings) | Not yet |
| [Check Whether It Actually Fits](recipes/check-whether-it-actually-fits.md) | [Yes](workflows/13-fit-and-limitations-review.md) | [Yes](.agents/skills/fit-and-limitations-review/SKILL.md) | [Two scored cases](evaluations/aldermere-fit-review-review.md) | [Test logged](CHANGELOG.md#real-use-findings) | Not yet |
| [Build a Business Case](recipes/build-a-business-case.md) | Not separate | [Yes](.agents/skills/build-business-case/SKILL.md) | [Three scored cases](evaluations/aldercroft-business-case-review.md), [prompt scored separately](evaluations/aldercroft-business-case-prompt-review.md) | [Test logged](CHANGELOG.md#real-use-findings) | Not yet |
| [Brief Your Champion](recipes/brief-your-champion.md) | [Yes](workflows/12-champion-enablement.md) | [Yes](.agents/skills/champion-enablement/SKILL.md) | [Scored](evaluations/hartwell-champion-enablement-review.md) | [Test logged](CHANGELOG.md#real-use-findings) | Not yet |
| [Chase a Quiet Prospect](recipes/chase-a-quiet-prospect.md) | Not separate | [Yes](.agents/skills/plan-chase-sequence/SKILL.md) | [Skill scored](evaluations/hartwell-chase-review.md), [prompt scored separately](evaluations/hartwell-chase-prompt-review.md) | [Test logged](CHANGELOG.md#real-use-findings) | Not yet |
| [Handle an Objection](recipes/handle-an-objection.md) | [Yes](workflows/05-objection-handling.md) | [Yes](.agents/skills/objection-response/SKILL.md) | [Four scored tests](evaluations/thornbury-objection-review.md) | [Test logged](CHANGELOG.md#real-use-findings) | Not yet |
| [Spot a Real Objection Pattern](recipes/spot-a-real-objection-pattern.md) | [Yes](workflows/11-objection-pattern-review.md) | [Yes](.agents/skills/review-objection-patterns/SKILL.md) | [Four scored tests](evaluations/fictional-objection-pattern-fourth-eval.md) | [Test logged](CHANGELOG.md#real-use-findings) | Not yet |
| [Move a Stalled Decision](recipes/move-a-stalled-decision.md) | [Yes](workflows/07-buyer-indecision.md) | [Yes](.agents/skills/identify-buyer-indecision/SKILL.md) | [Two scored cases](evaluations/wrenmoor-indecision-review.md) | [Test logged](evaluations/buyer-indecision-real-use-finding.md) | Not yet |
| [Hand Over an Opportunity](recipes/hand-over-an-opportunity.md) | [Yes](workflows/03-opportunity-handover.md) | [Yes](.agents/skills/opportunity-handover/SKILL.md) | [Scored](evaluations/hartwell-opportunity-handover-review.md) | [Test logged](evaluations/opportunity-handover-real-use-finding.md) | Not yet |
| [Review a Lost Opportunity](recipes/review-a-lost-opportunity.md) | [Yes](workflows/04-lost-opportunity-review.md) | [Yes](.agents/skills/review-lost-opportunity/SKILL.md) | [Scored](evaluations/hartwell-lost-opportunity-review.md) | [Test logged](evaluations/lost-opportunity-recovery-real-use-finding.md) | Not yet |
| [Review Your Pipeline](recipes/review-your-pipeline.md) | [Yes](workflows/06-pipeline-evidence-review.md) | [Yes](.agents/skills/pipeline-evidence-review/SKILL.md) | [Scored](evaluations/fictional-pipeline-review-eval.md) | [Test logged](CHANGELOG.md#real-use-findings) | Not yet |
...
| [Review an Outbound Campaign](recipes/review-an-outbound-campaign.md) | [Yes](workflows/14-outbound-campaign-learning-review.md) | Not yet | [Scored](evaluations/cedarwell-campaign-review-eval.md) | [Test logged](evaluations/outbound-campaign-real-use-finding.md) | Not yet |
...
Twelve of them. Two ran the same input repeatedly to measure how much a score moves on its own, nine compared an instruction with and without one change, and one compared two versions of a scenario rather than of an instruction. The third of those nine reused runs from the other two as its baseline rather than running its own, and the last seven were scored without knowing which version each run came from.
...
- **[Should the ledger be printed](evaluations/chase-ledger-printing-test.md)**: twelve runs, six a side, on an instruction that said the ledger was a working step while five of six runs printed it anyway. It asks whether the instruction can be made to hold before asking whether the printing is good, because an instruction that is ignored is wrong either way. Saying so explicitly stops it, zero of six against six of six, and every run in both arms still stated the date clash. It also puts a number on the trade nobody had measured: the ledger is about 139 words, roughly a quarter of the output.
- **[The ledger step where nothing collides](evaluations/chase-no-collision-test.md)**: twelve runs, six a side, asking whether a step that requires a collision check invents one when there is nothing to find. Neither arm produced a false collision, so the step is kept. It needed a new scenario, since no published input here had dates and an absence that did not overlap, and it closes the gap for false positives only.
- **[The ledger step on the skill](evaluations/chase-skill-ledger-test.md)**: twelve runs, six a side, taking the step that worked on the chase prompt and testing it on the skill. Six of six against zero of six, p of 0.0011, so it is adopted there too. It also records a prediction written down beforehand and got wrong: the published skill was worse at this than the published prompt, not better, and the earlier record that suggested otherwise turned out to have used a looser reading.
- **[The dated commitment ledger test](evaluations/chase-dated-commitment-ledger-test.md)**: twelve runs, six a side, on whether a required step beats a principle at getting the chase prompt to state a date clash it kept missing. Five of six against two of six, so the step is adopted, and the page says plainly that a one-tailed p of 0.12 does not reach the level treated as a result elsewhere here. It is the third test on that one defect and the first change it has not rejected, after thirty-six runs.
