...
This is the method I use to turn an AI idea into something a salesperson could actually use.

## 1. Start With the Job

Begin with a recurring sales task that is slow, inconsistent or easy to miss. Do not begin with a model or a new feature looking for a problem.

## 2. Use Only What Is Needed

Gather the smallest amount of approved information needed for the task. Check that it is current and remove personal or confidential details that do not belong in the workflow.

## 3. Decide Which Sources Matter Most
...
- **Estimate:** a number or view given without measurement
