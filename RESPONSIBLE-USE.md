...
- Synthetic transcripts and email threads
- Invented CRM records
- General sales problems
- Workflows and evaluation methods written for this project

## What Does Not Belong Here

- Real prospect or customer details
- Real call transcripts or email threads
- Passwords, credentials or private links
- Confidential pricing or commercial terms
- Employer specific CRM configuration
- Internal templates copied without permission
