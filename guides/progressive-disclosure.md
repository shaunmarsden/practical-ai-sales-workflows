...
| [draft-follow-up-email](../.agents/skills/draft-follow-up-email/SKILL.md) | 74 | Template and checklist |
| [plan-chase-sequence](../.agents/skills/plan-chase-sequence/SKILL.md) | 74 | Reference notes on sequence stages |
| [build-business-case](../.agents/skills/build-business-case/SKILL.md) | 79 | Audit checklist, two fictional examples |
| [extract-post-call-evidence](../.agents/skills/extract-post-call-evidence/SKILL.md) | 89 | Output schema, fictional example |

Every core file sits under ninety lines, and every skill with deeper material, an example, a template, a checklist, keeps it in a separate file rather than folded into `SKILL.md` itself. Nothing here fails the pattern. The audit's actual value is in having a place to check the next skill against, so a longer, more elaborate `SKILL.md` gets caught at review time rather than growing unnoticed.
