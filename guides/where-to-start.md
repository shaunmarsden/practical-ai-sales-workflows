...
If you already know the sales job you want help with, skip all of this: open the [recipe cards](../recipes/README.md), pick the job and paste the prompt that is on the card. Every one of the seventeen carries the prompt itself. The routes below are for working out what to learn next, not for getting one task done today.
