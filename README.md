...
```mermaid
flowchart LR
    A["Gather reliable information"] --> B["Use AI to organise it"]
    B --> C["Check facts and assumptions"]
    C --> D["Make the decision"]
    D --> E["Take action and learn"]
```
...
```mermaid
flowchart LR
    A["Gather reliable context"] --> B["Use AI to structure it"]
    B --> C["Check facts and assumptions"]
    C --> D["Make the human decision"]
    D --> E["Take action and learn"]
```
