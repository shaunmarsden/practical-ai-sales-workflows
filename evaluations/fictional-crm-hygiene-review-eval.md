...
- The two duplicate candidates are handled with genuinely different confidence, high for Northstar's shared contact name, low for Fenmoor/Fenmore's similar name alone, and the review explicitly refuses to suggest merging the second pair without a human check.
