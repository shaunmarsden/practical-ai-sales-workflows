...
These five controls are confirmed present in the public guide, template and fictional test that came out of this review. I indicated that I believed I had also applied equivalent changes to the private agent's own instructions, but that private, saved configuration was not independently verified as part of this review.
