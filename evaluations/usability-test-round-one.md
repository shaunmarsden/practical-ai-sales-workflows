...
1. Understand what the repository offers?
...
- a participant code, such as P01;
- their sales role;
...
- Run the session remotely by screen share or in person.
- Start the participant on the [repository homepage](../README.md).
...
> You have just finished the fictional Hartwell sales call.
>
> Starting from the Practical AI Sales Workflows homepage, use anything in the repository that appears helpful to:
>
> - understand what happened on the call;
> - prepare a safe follow-up email;
> - identify anything that still needs checking;
> - decide what you would do next.
>
> Use your normal AI assistant if the repository asks you to use one.
>
> Work as you normally would and explain what you are thinking. I will not guide you unless you become completely stuck.
...
- the route taken through the repository;
- time to find a relevant starting point;
...
- whether they noticed facts, estimates and unknowns;
- whether the finished output was usable.

## Questions After the Task

1. What did you think the repository was for when you first opened it?
2. Where did you expect to start?
3. What was the most confusing part?
4. What felt unnecessarily difficult?
5. Did you trust the finished output? Why?
6. What did you still need to check manually?
7. Would you use this approach after a real sales call?
8. What would stop you using it?
9. Which other sales job would you try next?
10. What is the single change that would make this more useful?
...
After the sessions, publish an anonymised evaluation covering:

- who participated, at a safe level of detail;
- what they were asked to do;
- observed results;
- repeated points of confusion;
- safety or evidence problems;
- changes made because of the test;
