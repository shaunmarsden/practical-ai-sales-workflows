...
Read [the fictional example](references/fictional-example.md) for a test, or [the Wrenmoor example](../../../examples/wrenmoor-indecision-input.md) for a harder test: a buyer whose stated reasons keep getting genuinely resolved, only for a new one to take each one's place. Two scored tests sit behind those: [Calderwood](../../../evaluations/calderwood-indecision-review.md), a late-stage deal that keeps slipping, and [Wrenmoor](../../../evaluations/wrenmoor-indecision-review.md). A [real use finding](../../../evaluations/buyer-indecision-real-use-finding.md) records a real opportunity that looked like indecision and turned out to be a policy blocker, where the right answer was not to use this method at all.
