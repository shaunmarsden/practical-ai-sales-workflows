...
- Next steps section present, with no language implying the process is finished once the document is sent
- No detail already confirmed in the conversation left as a placeholder
- Links are live and correctly labelled, not bare URLs or references to unsent attachments
